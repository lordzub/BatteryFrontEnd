...
BatteriesService.ctorParameters = () => [
    { type: _angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"] }
];
...
BatteryCardsComponent.ctorParameters = () => [
...
MachinesService.ctorParameters = () => [
    { type: _angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"] }
];
...
/* harmony import */ var _batteries_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../batteries.service */ "./src/app/batteries.service.ts");
/* harmony import */ var _machines_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../machines.service */ "./src/app/machines.service.ts");
...
let MachinesComponent = class MachinesComponent {
    ...
    getTableData() {
        this.MS.getMachines().subscribe((data) => {
            var machineData = JSON.parse(data['_body']);
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](machineData['machines']);
